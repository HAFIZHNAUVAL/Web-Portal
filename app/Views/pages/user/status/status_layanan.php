                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Status Pengajuan Layanan</h3>
                            <p class="text-subtitle text-muted">Keseluruhan Data Status Pengajuan Layanan Anda.</p>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <?php foreach ($statusLayanan as $j) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    if ($j['status'] == 0) {
                                                        ...
                                                        echo 'Selesai, Silahkan datang ke Kantor <br>';
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($j['status'] == 2) { // Tombol cetak hanya muncul jika statusnya "Selesai"
                                                            echo '<a href="' . base_url('User/' . $j['id'] . '/download') . '"> <span class="btn btn-primary text-white"><i class="bi bi-download"></i></span></a>';
                                                        }
                                                        ?>
                                        ...
                                        <?php else : ?>
                                            <div class="alert alert-warning" role="alert">
                                                <h4 class="alert-heading">Data Status Permohonan Layanan Tidak Tersedia</h4>
