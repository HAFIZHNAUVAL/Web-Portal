                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Pengajuan Layanan Anda</h3>
                            <p class="text-subtitle text-muted">Keseluruhan Data Pengajuan Layanan Anda.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('User/dashboard') ?>">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Pengajuan layanan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-left-end mt-6">
                                <a href="<?php echo base_url('User/create_pengajuan') ?>"> <span class="btn btn-success text-white"><i class="bi bi-plus-circle"></i></span></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php if ($layananData) : ?>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($layananData as $j) : ?>
                                                <tr>
                                                    ...
                                                    <?php
                                                    echo "<td>";
                                                    if ($j['jenis_pengajuan'] == 'Surat Pengantar KTP') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Pengantar KTP';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'SKCK') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'SKCK';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Ketarangan Usaha') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Ketarangan Usaha';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Ketarangan Umum') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Ketarangan Umum';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Kehilangan') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Kehilangan';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Tidak Mampu') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Keterangan Tidak Mampu';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Kuasa KK') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Kuasa KK';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Ijin Keluarga') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Ijin Keluarga';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Usaha ke Bank') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Keterangan Usaha ke Bank';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Ahli Waris') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Keterangan Ahli Waris';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Domisili') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        ...
                                                        echo 'Surat Ijin Keluarga';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Tanah Tidak Sengketa') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Keterangan Tanah Tidak Sengketa';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Penghasilan Orangtua') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Keterangan Penghasilan Orangtua';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Keterangan Pengaktifan BPJS') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Keterangan Pengaktifan BPJS';
                                                        echo "</span>";
                                                    } elseif ($j['jenis_pengajuan'] == 'Surat Pengajuan Dishub') {
                                                        echo "<span class='badge bg-secondary'>";
                                                        echo 'Surat Pengajuan Dishub';
                                                        echo "</span>";
                                                    }
                                                    ...
                                                    ?>
                                                    <td>
                                                        <a href="<?php echo base_url('User/' . $j['id'] . '/edit_layananUser') ?>"> <span class="btn btn-warning text-white"><i class="bi bi-pencil-square"></i></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else : ?>
                                            ...
                                            <div class="alert alert-warning" role="alert">
                                                <h4 class="alert-heading">Data Permohonan Layanan Tidak Tersedia</h4>
                                                <p>Silahkan Inputkan Data Permohonan Layanan Anda Terlebih Dahulu.</p>
                                            </div>
                                        <?php endif; ?>
                                        </tbody>
                                    </table>
