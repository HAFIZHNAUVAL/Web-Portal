        ...
        <div id="main">
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Sunting Pengajuan Layanan</h3>
                            <p class="text-subtitle text-muted">Silahkan edit form pengajuan layanan dibawah ini.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('User/dashboard') ?>">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Sunting layanan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <?php foreach ($layanan as $i) : ?>
                    <form method="post" action="<?php echo base_url('User/' . $i['id'] . '/update_layananUser') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Sunting Pengajuan Layanan</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php if ($avatarData) : ?>
                                                    ...
                                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama lengkap harus diinputkan" value="<?= $avatarData['nama']; ?>" readonly>
                                                ...
                                                <div class="form-group ">
                                                    <div class="custom-file">
                                                        <div class="position-relative">
                                                            <label for="image" class="form-label custom-file-input"><img width="100px" class="img-thumbnail" src="<?= base_url() . "/assets/images/pengajuan/" . $i['image']; ?>"></label>
