                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-1">
                                        ...
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control py-2" placeholder="Keterangan" id="judul_image" name="judul_image" />
                                ...
                                <div class="d-flex justify-left-end mt-6">
                                    <button type="submit" name="submit" value="Upload" class="btn btn-success mb-2 btn-pill">Tambah User</button>
                                    &nbsp;&nbsp;
                                ...
                                <div class="row">
                                    ...
                                    <!-- <td><img src="//<? //base_url('image/' . $row['image']); 
                                                            ?>" width="100"></td> -->
