                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Aduan Anda</h3>
                            <p class="text-subtitle text-muted">Keseluruhan Data Aduan Anda.</p>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-left-end mt-6">
                                <a href="<?php echo base_url('User/create_aduan') ?>"> <span class="btn btn-success text-white"><i class="bi bi-plus-circle"></i></span></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php if ($aduanData) : ?>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($aduanData as $k) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    if ($k['kategori'] == 'Insfraktruktur') {

                                                        echo 'Insfraktruktur';
                                                        echo "</span>";
                                                    } elseif ($k['kategori'] == 'Pelayanan') {

                                                        echo 'Pelayanan';
                                                        echo "</span>";
                                                    } elseif ($k['kategori'] == 'Lainnya') {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <a href="<?php echo base_url('User/' . $k['id'] . '/edit_aduan') ?>"> <span class="btn btn-warning text-white"><i class="bi bi-pencil-square"></i></span></a>
                                        ...
                                        <?php else : ?>
                                            ...
                                            <div class="alert alert-warning" role="alert">
                                                <h4 class="alert-heading">Data Aduan Tidak Tersedia</h4>
