    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Form aduan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <hr>
                <div class="mb-5">
                    <a data-bs-toggle="tooltip" data-bs-original-title="Kembali ke halaman sebelumnya." href="<?php echo base_url('User/aduan') ?>" class="btn btn-secondary px-3 pt-2 me-2">
                ...
                <?php endif; ?>
                <form method="post" action="<?php echo base_url('User/upload_file') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Buat Aduan Anda</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control py-2" placeholder="Judul keluhan" id="judul" name="judul" autofocus />
                                        ...
                                        <div class="form-group has-icon-left ">
                                            <?php if ($avatarData) : ?>
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" id="nik" name="nik" value="<?= $avatarData['nik']; ?>" readonly>
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-card-heading py-2"></i>
                                                    </div>
                                                    <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                    ...
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left ">
                                            <?php if ($avatarData) : ?>
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" id="nama" name="nama" value="<?= $avatarData['nama']; ?>" readonly>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama lengkap harus diisi" readonly>
                                        ...
                                        <div class="form-group has-icon-left ">
                                            <?php if ($avatarData) : ?>
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" id="alamat" name="alamat" value="<?= $avatarData['alamat']; ?>" readonly>
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-card-heading py-2"></i>
                                                    </div>
                                                    <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                            ...
                                            <?php else : ?>
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Alamat harus diisi" readonly>
                                    ...
                                    <div class="d-flex justify-left-end mt-6">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="<?php echo base_url('User/aduan') ?>" class="btn btn-danger mb-2 btn-pill">Batal</a>
                                    </div>
                                    <br>
                                </div>
                            </div>
