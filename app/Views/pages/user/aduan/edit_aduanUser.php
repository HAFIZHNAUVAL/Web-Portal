        ...
        <div id="main">
            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Sunting aduan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <?php foreach ($aduan as $k) : ?>
                    <form method="post" action="<?php echo base_url('User/' . $k['id'] . '/update_aduan') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Sunting Aduan</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-1">
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" placeholder="Judul keluhan" id="judul" name="judul" value="<?= $k['judul']; ?>" autofocus />
                                            ...
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" placeholder="NIK" id="nik" name="nik" value="<?= $k['nik']; ?>" readonly />
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-card-heading py-2"></i>
                                                    </div>
                                                    <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                        ...
                                        <div class="col-md-6 col-12 mb-1">
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" placeholder="Nama Pengadu" id="nama" name="nama" value="<?= $k['nama']; ?>" readonly />
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-card-heading py-2"></i>
                                                    </div>
                                                    <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                            ...
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" placeholder="RT/RW" id="alamat" name="alamat" value="<?= $k['alamat']; ?>" readonly />
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-card-heading py-2"></i>
                                                    </div>
                                                    <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
