    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Form profile user</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <?php endif; ?>
                <form method="post" action="<?php echo base_url('User/upload_profile') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="negara" name="negara" placeholder="Enter Negara">
                                        </div>
                                    ...
                                    <div class="d-flex justify-left-end mt-6">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="<?php echo base_url('User/dashboard') ?>" class="btn btn-danger mb-2 btn-pill">Batal</a>
                                    </div>
                                    <br>
                                </div>
                            </div>
