    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Silahkan ganti kata sandi demi keamanan pengguna.</p>
                        </div>
                ...
                <form method="post" action="<?php echo base_url('User/changePassword') ?>" class="form-horizontal" role="form">
                                ...
                                <div class="row">
                                    <div class="col-12 mt-3 d-flex justify-content-start">
                                        ...
                                        <div class="d-flex justify-left-end mt-6">
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="<?php echo base_url('User/dashboard') ?>" value="Change Password" class="btn btn-danger mb-2 btn-pill">Batal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
